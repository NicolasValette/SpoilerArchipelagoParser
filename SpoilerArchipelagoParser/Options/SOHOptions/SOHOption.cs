...
namespace NoNiDev.SpoilerArchipelagoParser.Options.SOHOptions
{
    ...
    {
        #region GREEN
        public string Triforce_Hunt { get; set; } = string.Empty;
        public string Triforce_Hunt_Pieces_Total { get; set; } = string.Empty;
        public string Triforce_Hunt_Pieces_Required_Percentage { get; set; } = string.Empty;
        [SpoilerName("Accessibility With Attribute")]
        public string Accessibility { get; set; } = string.Empty;
        public string Progression_Balancing { get; set; } = string.Empty;
        #endregion
        #region DOORS
